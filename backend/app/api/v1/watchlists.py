...
async def add_to_watchlist(
    ...
    try:
        ...
        logger.info(f"Added to watchlist: user_id={current_user.id}, symbol={watchlist_data.symbol}")
        return db_watchlist
...
async def remove_from_watchlist(
    ...
    try:
        ...
        logger.info(f"Removed from watchlist: user_id={current_user.id}, watchlist_id={watchlist_id}")
...
async def remove_from_watchlist_by_symbol(
    ...
    try:
        ...
        logger.info(f"Removed from watchlist: user_id={current_user.id}, symbol={symbol}")
        return {"message": "Removed from watchlist"}
    except HTTPException:
        db.rollback()
        raise

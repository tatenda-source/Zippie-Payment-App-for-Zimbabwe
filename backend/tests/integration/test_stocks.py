...
class TestStocks:
    ...
    def test_get_stock_quote(self, mock_get_quote, authenticated_client, mock_stock_quote):
    ...
    @patch('app.api.v1.stocks.stock_api_service.get_quote')
    def test_get_stock_quote_not_found(self, mock_get_quote, authenticated_client):
    ...
    def test_get_historical_data(self, mock_get_historical, authenticated_client):
        ...
        response = authenticated_client.get("/api/v1/stocks/historical/AAPL?period=1mo")
    ...
    def test_get_prediction(self, mock_predict, mock_historical, authenticated_client):
        ...
        response = authenticated_client.get("/api/v1/stocks/predict/AAPL?timeframe=1d")
